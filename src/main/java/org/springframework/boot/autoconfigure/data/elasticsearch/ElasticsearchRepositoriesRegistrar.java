...
//	private final String basePackages = "com.massestech.jc";
...
//		System.out.println("-----------" + super.getBasePackages());
//		List<String> basePackagesList = new ArrayList<String>();
//		basePackagesList.add(basePackages);
